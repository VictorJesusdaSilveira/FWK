...
<td><a href= '../control/alunoControl.php?acao=3&id=<?php echo $dado['id_aluno'] ?>'>Excluir</a></td>
<td><a href='../control/alunoControl.php?acao=4&id=<?php echo $dado['id_aluno'] ?>'>Atualizar</td>
</tr>
    <?php
    }
    ?>
