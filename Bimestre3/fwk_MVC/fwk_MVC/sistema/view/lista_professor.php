...
<td><a href= '../control/professorControl.php?acao=3&id=<?php echo $dado['id_professor'] ?>'>Excluir</a></td>
<td><a href='../control/professorControl.php?acao=4&id=<?php echo $dado['id_professor'] ?>'>Atualizar</td>
</tr>
    <?php
    }
    ?>
